...
def test_mystudy_webservice():
    ...
    try:
        ...
        print("\n==> Test: get_all_semester")
        print(service.get_all_semester())
        ...
        print("\n==> Test: get_all_personen")
        print(service.get_all_personen())

        print("\n==> Test: get_personen_from_nachname")
        print(service.get_personen_from_nachname("Muster"))
        ...
        print("\n==> Test: get_all_sprachen")
        print(service.get_all_sprachen())
        ...
        print("\n==> Test: get_all_studiengaenge")
        print(service.get_all_studiengaenge())
        ...
        print("\n==> Test: search_veranstaltungen")
        print(service.search_veranstaltungen(1, 1, 1, "Test", "Dozent", 1))
        ...
        print("\n==> Test: get_all_veranstaltungs_tags")
        print(service.get_all_veranstaltungs_tags())
